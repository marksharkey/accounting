...
export default function CreditMemoBuilderPage() {
  ...
  const createMemo = useMutation({
    ...
    onError: (error) => {
      alert('Error creating credit memo: ' + (error.response?.data?.detail || error.message));
    },
  });
  ...
  return (
    <Layout title="Create Credit Memo">
      <div className="grid grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <p className="text-xs text-gray-500">Add services or manual line items for the credit</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Credit Memo Summary</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Button
                ...
                variant="secondary"
              >
                {createMemo.isPending ? 'Saving...' : 'Save Draft'}
              </Button>
              <Button
                ...
                className="w-full"
              >
                {createMemo.isPending ? 'Creating...' : 'Mark Ready & Send'}
              </Button>
            </div>
          </CardContent>
        </Card>
